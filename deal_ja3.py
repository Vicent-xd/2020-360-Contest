...
if export :
    ...
    ip_ja3_white_export.to_csv('ip_ja3_white_export.csv',index=False,header=True,columns=None)
    ...
    ip_ja3_black_export.to_csv('ip_ja3_black_export.csv',index=False,header=True,columns=None)
